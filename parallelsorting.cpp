...
int main() {
    ...
    cout << "\nSequential Merge Sort Time: " << (end - start) * 1000000 << " micros";
    ...
    cout << fixed << setprecision(3);
    cout << "\nParallel Merge Sort Time: " << (end - start) * 1000000 << " micros\n";

    return 0;
}

// execution command: g++ -fopenmp parallelsorting.cpp -o c.exe
// ./c.exe